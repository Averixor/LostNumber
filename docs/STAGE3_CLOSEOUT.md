...
> **Historical Stage 3 note (2026-08-04).** Current identity / CT: [`STAGE1_RELEASE_RECORD.md`](STAGE1_RELEASE_RECORD.md) — **NO-GO** until Auth-ready AAB.

- CT status (Stage 3 era): `pending` on legacy AAB `398b83f3…` @ `2ef0fcd…` — **superseded**
- Current CT: **NO-GO** — [`CT_SMOKE_CHECKLIST.md`](CT_SMOKE_CHECKLIST.md)
- Do **not** upload `398b83f3…` / `1463fd4c…` / `5c0530b0…`
