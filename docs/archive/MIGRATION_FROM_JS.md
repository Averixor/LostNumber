...
> **Note (2026-07):** The browser/JS game has been removed from the repo. This document is a **historical parity map** only.

Lost Number **2.1.6** ships on **Godot 4.5** / GDScript only.

Canonical decisions: `docs/en/SOURCE_OF_TRUTH.md`. Visual port status: `docs/archive/VISUAL_PORT_MAP.md`.
...
One-time import is **done**: `LegacySaveMigration.gd` (startup + Settings → Import) and the `LostNumberMigration` Android plugin. Details: `docs/LEGACY_SAVE_MIGRATION.md`, `docs/en/DECISIONS.md`.
