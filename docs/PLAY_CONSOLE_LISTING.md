...
> **Privacy URL** має відкриватися в браузері до відправки на перевірку. Після merge у `main` Pages деплоїть лише `privacy.html` (див. [PRIVACY_HOSTING.md](./PRIVACY_HOSTING.md)).
