...
const KEY_ALIASES := {
	...
	"settings_visual_skin_pick": "settings_visual_skin_pick",
	"settings_visual_skin_auto": "settings_visual_skin_auto",
	"settings_background_label": "settings_background_label",
	"settings_background_auto": "settings_background_auto",
	"background_preview_title": "background_preview_title",
