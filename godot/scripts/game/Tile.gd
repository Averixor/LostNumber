...
func _apply_material_face(face_color: Color) -> void:
	...
	_face_material.set_shader_parameter("face_color", Color(face_color.lightened(0.04), 0.94))
...
func _refresh_visual() -> void:
	...
	var text_color := _theme_text_color() if material_style != null else ThemeTokensLib.tile_text_color_for(face_color, value)
