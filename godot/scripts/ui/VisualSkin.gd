...
@export var success_color: Color = Color(0.290, 0.569, 0.322, 1.0) # emerald jewel #4A9152
...
@export var chain_valid_color: Color = Color(0.435, 0.851, 0.290, 1.0) # lime accent #6FD94A
