...
Інтерфейс локалізовано (**українська**, російська, англійська). Типовий розмір сітки — **5×8**; ціль на рівні зростає разом із прогресом.
...
Для розробки зручно щось на кшталт:
...
Живий приклад на GitHub Pages: [averixor.github.io/LostNumber](https://averixor.github.io/LostNumber/) (налаштування деплою — у вашому репозиторії GitHub).
