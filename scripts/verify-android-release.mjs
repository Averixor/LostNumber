...
function ensureSiteBundle() {
  const required = [
    '_site/assets/images/menu-bg-1.png',
    '_site/assets/images/menu-bg-2.png',
    '_site/assets/images/menu-bg-3.png',
    '_site/assets/images/menu-bg-4.png',
    '_site/assets/images/menu-bg-5.png',
    '_site/assets/images/menu-bg-6.png',
