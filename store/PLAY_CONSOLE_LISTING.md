...
> **Privacy URL** має відкриватися в браузері до відправки на перевірку. Після merge у `main` Pages деплоїть лише `privacy.html` (див. [docs/PRIVACY_HOSTING.md](../docs/PRIVACY_HOSTING.md)).
...
| 01-menu-dark      | **Реальний** знімок: головне меню Lost Number (uk).                           |
| 02-gothic-style   | **Реальний** знімок: ігрове поле, HUD, бонуси.                                |
| 03-levels-bonuses | Promo draft — замінити на Settings у Stage 2.                                 |
| 04-offline-calm   | Promo draft — замінити на Wheel у Stage 2.                                    |
